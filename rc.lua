...
sshmenu = {
    { "ccnp.no", terminal .. " -e ssh ccnp.no" },
    { "ns1", terminal .. " -e ssh ns1.fong.lan" },
    { "pink", terminal .. " -e ssh pink.fong.lan" }
}

tapiomenu = {
   { "chrome", "/usr/bin/google-chrome" },
   { "firefox", "firefox" },
   { "ncmpc", terminal .. "-e ncmpc --host=localhost" },
   { "gimp", "gimp" }
}

mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "ssh", sshmenu, beautiful.awesome_icon },
                                    { "firefox", "firefox" },
...
fswidget_home = widget({ type = "textbox" })
fswidget_warez = widget({ type = "textbox" })

-- Register widget filesystem widgets
...
gmailwidgetsub = widget({ type = "textbox" })

-- Register widgets
vicious.register(gmailwidgetcnt, vicious.widgets.gmail, "${count}", 260)
vicious.register(gmailwidgetsub, vicious.widgets.gmail, "${subject}", 260)
...
for s = 1, screen.count() do
    ...
    -- Add widgets to the wibox for the left screen
mywibox[1].widgets = {
    {
        mylauncher,
        mytaglist[1], 
   ...
   mylayoutbox[1],
    spacer, upicon, spacer, netwidget, dnicon, spacer, separator,
    spacer, fswidget_warez, spacer, fswidget_home, spacer, fswidget_root, spacer, fsicon, spacer, separator, 
    spacer, memwidget, spacer, memicon, spacer, separator, 
    spacer, cpuwidget, spacer, cpuicon, separator,
    spacer, gmailwidgetcnt, spacer, gmailicon, spacer, separator,
    spacer, pacwidget, spacer, pacicon, spacer, 
    mytasklist[1],
    layout = awful.widget.layout.horizontal.rightleft
}

    -- Add widgets to the wibox for the right screen
mywibox[2].widgets = {
    {
        mylauncher,
        mytaglist[2], 
    ...
    spacer, mysystray, spacer, separator,
    spacer, mpdwidget, spacer, mpdicon, spacer,
    mytasklist[2],
    layout = awful.widget.layout.horizontal.rightleft
}
...
awful.rules.rules = {
  ...
  --   { rule = { class = "Firefox" },
--       properties = { tag = tags[client.focus.screen][2] } },
    -- Set urxvt to allways map on tag number 3 of current focused screen.
 --    { rule = { class = "urxvt" },
     --  properties = { tag = tags[client.focus.screen][3] } },
   --  { rule = { class = "mplayer" },
      -- properties = { tag = tags[client.focus.screen][1] } },
